...
1. Open the board where you want to add the card.
2. Navigate to the area (column) where the card should be placed.
3. Click on the "Add Card" button.
4. Enter a title for the card.
5. Optionally, add a description or other details.
...
3. Update the title, description, or other details as needed.
4. Click "Save" to apply your changes.

### Moving a Card
1. Drag and drop the card to the desired area (column) or position within the same area.
2. The changes will be saved automatically.

### Deleting a Card
1. Open the card you want to delete.
